import { Injectable, NotFoundException, ForbiddenException, RawBodyRequest } from '@nestjs/common';
...
export class PaymentsService {
  ...
  async createCheckoutSession(applicationId: string, employerId: string) {
    ...
    if (application.job.employerId !== employerId) throw new ForbiddenException('You do not own this job');
    if (application.isAccepted) throw new ForbiddenException('Application is already accepted');
